...
import { setupEvaluationContext, runFixture } from './evaluate-structural.js';
import { FitnessEvaluator } from './lib/fitness-evaluator.js';
import { initWeights, orderedEdgeIds, loadEdges, edgeIdFromEdge } from './lib/weight-persistor.js';
