// =============================================================================
// ws-protocol-shared.ts — Skytrix WS protocol — shared primitives + board
// Zero internal imports — copied verbatim to Angular.
// Manual sync: duel-server/src/ws-protocol-shared.ts ↔ front/src/app/pages/pvp/duel-ws-shared.types.ts
