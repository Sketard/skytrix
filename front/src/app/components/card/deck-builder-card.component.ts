/**
 * LEGACY — Deck builder card component preserved for backward compatibility.
 * Will be replaced by shared CardComponent (app-card) in Story 8.4.
 */
...
@Component({
  ...
  styleUrl: './deck-builder-card.component.scss',
  standalone: true,
