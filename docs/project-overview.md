...
├── front/                  # Angular 19.1.3 (SPA: deck mgmt + simulator + PvP + replay + solver)
...
| Layer | Technology |
|---|---|
| Frontend | Angular 19.1.3, Material 19.1.1, CDK DragDrop, TypeScript 5.5.4 strict, RxJS 7.8.0, ngx-translate 16.0.4, Karma+Jasmine, Playwright (e2e) |
